...
| **rotate:tweak[^1]**  | **(float3f)** 3D rotation around the center of the plate in degrees.[^2] | **(float)** Rotation in degrees of the image plane on the sensor around the z-axis.[^2] | 
